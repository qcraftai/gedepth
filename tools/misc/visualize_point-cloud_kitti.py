...
def main():
    ...
    for idx, input in enumerate(data_loader):
        ...
        h, w = depth.shape[1]-100,depth.shape[2]
        fx = cam_intrinsic[0][0]
        fy = cam_intrinsic[1][1]
        cx = cam_intrinsic[0][2]-50
        ...
        depth = depth[0, 100:depth.shape[1], :].contiguous()
        ...
        img_tensor = torch.tensor(img[100:img.shape[0], :, :], dtype=torch.uint8)

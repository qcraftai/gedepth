...
# runtime settings
runner = dict(type='IterBasedRunner', max_iters=16 * 48)
checkpoint_config = dict(by_epoch=False, max_keep_ckpts=2, interval=8)
...
# find_unused_parameters=True
# resume_from = "/home/mazhuang/workspace/PE/work_dirs/depthformer_swinl_22k_w7_kitti_dynamic_pe_light_att_double_iter_k_mse_loss_debug/iter_800.pth"
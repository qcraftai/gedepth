...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'dynamic_pe_neck':dict(lr_mult=10,decay_mult=0.001),
            # 'dynamic_pe_backbone':dict(lr_mult=10)
        }))
# learning policy
lr_config = dict(
...
# resume_from = "/home/mazhuang/workspace/PE/work_dirs/depthformer_swinl_22k_w7_kitti_dynamic_pe_light_att_double_iter_overfit/latest.pth"
# load_from = "/home/mazhuang/workspace/PE/work_dirs/depthformer_swinl_22k_w7_kitti_dynamic_pe_light_att_double_iter_overfit/latest.pth"
# find_unused_parameters=True
# resume_from = "/home/mazhuang/workspace/PE/work_dirs/depthformer_swinl_22k_w7_kitti_dynamic_pe_light_att_double_iter_k_classification_debug/iter_800.pth"
# resume_from = "/home/mazhuang/workspace/PE/work_dirs/depthformer_swinl_22k_w7_kitti_dynamic_pe_light_att_double_iter_k_classification_debug_test_gpu/best_abs_rel_iter_75200.pth"
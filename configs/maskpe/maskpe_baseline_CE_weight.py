...
USEPE_FLAGS = True
USE_GT_FILTER_FLAGS = True
USE_ConvexHull_FLAGS = True
USE_Erode_FLAGS = True
USE_Dilate_FLAGS = True
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name="maskpe_baseline_CE_weight",
                tags=[
                    "8gpus",
                ],
                entity="mazhuang",
...
# resume_from = "/mnt/vepfs/ML/Users/mazhuang/PE/Monocular-Depth-Estimation-Toolbox/work_dirs/maskpe_baseline_CE_weight/best_abs_rel_iter_11200.pth"
# load_from = "/mnt/vepfs/ML/Users/mazhuang/PE/Monocular-Depth-Estimation-Toolbox/work_dirs/maskpe_baseline_CE_weight/best_abs_rel_iter_11200.pth"

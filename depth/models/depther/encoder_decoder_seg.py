...
from .base_seg import BaseSegmentor
from IPython import embed


@DEPTHER.register_module()
class EncoderDecoderSEG(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(EncoderDecoderSEG, self).__init__(init_cfg)
    ...
    def _decode_head_forward_train(self, img, x, img_metas, depth_gt, **kwargs):
        ...
        training."""
        losses = dict()
        loss_decode = self.decode_head.forward_train(x,**kwargs)
    ...
    def _auxiliary_head_forward_train(self, x, img_metas, depth_gt, **kwargs):
        ...
        if isinstance(self.auxiliary_head, nn.ModuleList):
            ...
            loss_aux = self.auxiliary_head.forward_train(
                x, img_metas, depth_gt, self.train_cfg,**kwargs)
    ...
    def forward_train(self, img, img_metas, depth_gt, **kwargs):
        ...
        if self.with_auxiliary_head:
            loss_aux = self._auxiliary_head_forward_train(img, x, img_metas, depth_gt, **kwargs)

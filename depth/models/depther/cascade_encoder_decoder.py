...
from .encoder_decoder_seg import EncoderDecoderSEG
from IPython import embed


@DEPTHER.register_module()
class CascadeEncoderDecoder(EncoderDecoderSEG):
    ...
    def _decode_head_forward_train(self, img, x, img_metas, depth_gt, **kwargs):
        ...
        for i in range(1, self.num_stages):
            ...
            loss_decode = self.decode_head[i].forward_train(img, x, prev_outputs, img_metas, depth_gt, self.train_cfg, **kwargs)

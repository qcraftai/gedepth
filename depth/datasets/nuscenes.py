...
class NUSCENESDataset(Dataset):
    """NUSCENE dataset for depth estimation. An example of file structure
    is as followed.
    .. code-block:: none
        ├── data
        │   ├── KITTI
    ...
    def eval_kb_crop(self, depth_gt,h,w):
        ...
        depth_cropped = depth_gt[top_margin: top_margin + h, left_margin: left_margin + w]
    ...
    def pre_eval(self, preds, indices):
        ...
        for i, (pred, index) in enumerate(zip(preds, indices)):
            ...
            depth_map_gt = self.eval_kb_crop(depth_map_gt,pred.shape[1],pred.shape[2])
